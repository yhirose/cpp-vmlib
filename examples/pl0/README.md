...
`peglib.h`; nothing under `include/coreir/` or `vm/` knows PL/0 or peglib
exist.
...
position and exit code match `tests/errors/expected/`.
...
`tests/errors/recursion.pas` exists because none of the samples recurse
